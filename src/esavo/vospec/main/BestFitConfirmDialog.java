 ...
 * @author jgonzale
 */
public class BestFitConfirmDialog extends javax.swing.JDialog {

    BestFitThread bestFitThread;

    /** Creates new form BestFitConfirmDialog */
    public BestFitConfirmDialog(java.awt.Frame parent, boolean modal, BestFitThread thread) {
        super(parent, modal);
        initComponents();
        this.bestFitThread = thread;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Fitting process finished. Load the results now?");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BestFitConfirmDialog dialog = new BestFitConfirmDialog(new javax.swing.JFrame(), true, null);
