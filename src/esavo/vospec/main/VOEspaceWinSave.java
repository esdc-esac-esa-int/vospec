 ...
 * @author  ibarbarisi
 */
public class VOEspaceWinSave extends javax.swing.JDialog {
    ...
    public VOEspaceWinSave() {
        initComponents();
    }
     public VOEspaceWinSave(List list) {
        this();
        this.list = list;
        addList();
        this.setTitle("VOEspace Save");
    }
...
//        System.out.println("http://"+EnvironmentDefs.SERVERHOST+":8080/vospec/esavo/vospec/images/openVOEspace.gif");
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .add(jLabel2)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(fileName, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 217, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        VOSPEC.setVOEspaceFileName(fileName.getText());
        VOSPEC.saveFileInVOEspace();
        VOSPEC.setVisible(true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VOEspaceWinSave().setVisible(true);
            }
        });
    }
