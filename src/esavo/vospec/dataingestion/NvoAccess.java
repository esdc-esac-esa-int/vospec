...
/**
 * NVO Registry WebServices Access Class
 * @author Aurelien STEBE
 * @version 3.0
 */
public class NvoAccess {
    /**
     * creates a new instance of NvoAccess
     */
    public NvoAccess() {
    }

    /**
     * get the Resources from the NVO Registry
    ...
    public String callQueryResource(String predicate) throws Exception {
        ...
        QName portName = new QName("ivoa.net.riws.v10", "NVORegIntSoap");
        QName queryOp = new QName("ivoa.net.riws.v10", "VOTCapability");
        ...
        try {
        	...
        	call.setTargetEndpointAddress(EnvironmentDefs.getREGISTRYNVOURL());
        	call.setSOAPActionURI("ivoa.net.riws.v10/VOTCapability");
            call.setTimeout(3000);

        	// prepare the input parameter
        	SOAPBodyElement[] input = new SOAPBodyElement[1];
        	input[0] = new SOAPBodyElement(queryOp);
        	input[0].addChildElement("capability").addTextNode(predicate);
        	...
        	xmlResult = ((MessageElement) result).getAsString();
        	    ...
        	    // set the endpoint and operation
        	    call.setTargetEndpointAddress(EnvironmentDefs.getREGISTRYNVOURLMIRROR());
                    call.setSOAPActionURI("ivoa.net.riws.v10/VOTCapability");
      ...
      * @throws Exception throws back any exception
      */
    public String xsltResource2Table(String voResource, String xslFileUrl)
            throws Exception {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        String predicate = "SimpleSpectralAccess";
        ...
        try {
            // call the NVO Registry WebServices
            NvoAccess nvoAccess = new NvoAccess();
            String queryResult = nvoAccess.callQueryResource(predicate);
