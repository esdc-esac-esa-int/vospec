 ...
 * @author jgonzale
 */
public class SingleSpectrumSenderListener extends NotificationSenderListener {

    private Spectrum spectrum;

    public SingleSpectrumSenderListener(String messageType, Interop interopAccessor, Spectrum spectrum) {
