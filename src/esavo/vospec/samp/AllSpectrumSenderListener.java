...
public class AllSpectrumSenderListener extends NotificationSenderListener {

    private VOSpecDetached aiospectooldetached;

	public AllSpectrumSenderListener(String messageType,Interop interopAccessor, VOSpecDetached aiospectooldetached) {
    ...
    protected Message buildMessage() {
        ...
        meta.put("Access.Format", "application/votable");
        message.addParam("meta", meta);
